    ...
    <div className="min-h-screen bg-navy flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-white/40 text-sm mt-1">Créer votre compte</p>
        </div>
        <form onSubmit={handleSubmit} className="bg-white rounded-2xl p-7 shadow-2xl space-y-4">
          <div>
            <label className="label">Nom complet</label>
            <input type="text" required placeholder="Karim Benali" className="input"
          ...
          <div>
            ...
            <input type="password" required minLength={6} placeholder="Min 6 caractères" className="input"
